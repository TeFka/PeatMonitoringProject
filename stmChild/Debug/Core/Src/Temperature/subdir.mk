...
C_SRCS += \
../Core/Src/Temperature/TemperatureSensing.c 

OBJS += \
./Core/Src/Temperature/TemperatureSensing.o 

C_DEPS += \
./Core/Src/Temperature/TemperatureSensing.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Temperature/%.o Core/Src/Temperature/%.su: ../Core/Src/Temperature/%.c Core/Src/Temperature/subdir.mk
...
clean-Core-2f-Src-2f-Temperature:
	-$(RM) ./Core/Src/Temperature/TemperatureSensing.d ./Core/Src/Temperature/TemperatureSensing.o ./Core/Src/Temperature/TemperatureSensing.su
